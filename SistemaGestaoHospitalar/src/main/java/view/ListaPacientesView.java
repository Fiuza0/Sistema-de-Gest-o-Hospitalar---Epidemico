...
public class ListaPacientesView extends JFrame{
	...
	public ListaPacientesView() {
		...
		final JList<Atendimento> listPacientes = new JList<Atendimento>();
		listPacientes.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		listPacientes.setModel(new AbstractListModel<Atendimento>() {
		...
		listPacientes.setBounds(24, 16, 374, 202);
		scrollList.setViewportView(listPacientes);
		...
		lblPacientes.setForeground(new Color(47, 79, 79));
		lblPacientes.setFont(new Font("Lucida Sans", Font.BOLD, 14));
		lblPacientes.setBounds(260, 19, 75, 16);
