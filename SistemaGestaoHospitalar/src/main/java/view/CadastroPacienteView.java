...
public class CadastroPacienteView extends JFrame{
	...
	public CadastroPacienteView() {
		...
		setContentPane(contentPane);
			...
			lblCadastroPaciente.setForeground(new Color(47, 79, 79));
			lblCadastroPaciente.setFont(new Font("Lucida Sans", Font.BOLD, 14));
			lblCadastroPaciente.setBounds(233, 17, 129, 16);
