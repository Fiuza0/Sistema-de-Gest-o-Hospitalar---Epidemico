...
public class CadastroSalaView extends JFrame {
	...
	public CadastroSalaView() {
		...
		JLabel lblNumero = new JLabel("N\u00FAmero da Sala:");
		lblNumero.setForeground(Color.BLACK);
		lblNumero.setFont(new Font("SansSerif", Font.BOLD, 12));
		lblNumero.setBounds(245, 99, 97, 16);
		panel.add(lblNumero);
		
		textFieldNum = new JTextField();
		textFieldNum.setBounds(245, 126, 97, 28);
		...
		lblNomeDoFuncionario.setBounds(18, 6, 204, 16);
