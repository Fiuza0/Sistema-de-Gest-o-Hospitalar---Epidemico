...
public class ConsultaEspecialidadeView extends JFrame {
	...
	public ConsultaEspecialidadeView() {
		...
		btnAlterar.setBounds(252, 244, 90, 28);
		panel.add(btnAlterar);

		JLabel lblSucesso = new JLabel("");
		lblSucesso.setBounds(220, 288, 154, 16);
		...
		JLabel lblCadastroEspecialidade = new JLabel("Consulta Especialidade");
		lblCadastroEspecialidade.setForeground(new Color(47, 79, 79));
		lblCadastroEspecialidade.setFont(new Font("Lucida Sans", Font.BOLD, 14));
		lblCadastroEspecialidade.setBounds(211, 27, 173, 16);
		panel.add(lblCadastroEspecialidade);
		...
		lblCodigo.setBounds(276, 154, 42, 16);
		panel.add(lblCodigo);
		
		JLabel lblCdEspecialidade = new JLabel("");
		lblCdEspecialidade.setHorizontalAlignment(SwingConstants.CENTER);
		lblCdEspecialidade.setForeground(Color.BLACK);
		lblCdEspecialidade.setFont(new Font("SansSerif", Font.BOLD, 12));
		lblCdEspecialidade.setBounds(230, 181, 135, 16);
		panel.add(lblCdEspecialidade);
