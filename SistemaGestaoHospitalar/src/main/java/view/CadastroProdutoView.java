...
public class CadastroProdutoView extends JFrame {
	...
	public CadastroProdutoView() {
		...
		btnCadastrar.setBounds(252, 285, 90, 28);
		...
		lblCadastroProduto.setBounds(234, 27, 126, 16);
		...
		lblEstoqueProduto.setBounds(238, 166, 119, 16);
		...
		lblQuantidade.setBounds(263, 190, 68, 16);
		panel.add(lblQuantidade);
		
		textField = new JTextField();
		textField.setColumns(10);
		textField.setBounds(245, 217, 104, 28);
		panel.add(textField);
