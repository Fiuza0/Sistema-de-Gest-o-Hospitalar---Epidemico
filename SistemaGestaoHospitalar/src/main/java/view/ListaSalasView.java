...
public class ListaSalasView extends JFrame{

	private JPanel contentPane;

	
	public ListaSalasView() {
		...
		final JList<Atendimento> listSalas = new JList<Atendimento>();
		listSalas.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		listSalas.setModel(new AbstractListModel<Atendimento>() {
		...
		listSalas.setSelectedIndex(0);
		listSalas.setBounds(24, 16, 374, 202);
		scrollList.setViewportView(listSalas);
		...
		lblSalas.setForeground(new Color(47, 79, 79));
		lblSalas.setFont(new Font("Lucida Sans", Font.BOLD, 14));
		lblSalas.setBounds(276, 19, 42, 16);
		panel.add(lblSalas);
