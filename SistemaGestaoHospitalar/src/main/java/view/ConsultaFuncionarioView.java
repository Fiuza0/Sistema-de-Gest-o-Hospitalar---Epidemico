...
public class ConsultaFuncionarioView extends JFrame{
	...
	public ConsultaFuncionarioView() {
		...
		setContentPane(contentPane);
			...
			JLabel lblConsultaFuncionario = new JLabel("Consulta Funcionario");
			lblConsultaFuncionario.setForeground(new Color(47, 79, 79));
			lblConsultaFuncionario.setFont(new Font("Lucida Sans", Font.BOLD, 14));
			lblConsultaFuncionario.setBounds(219, 17, 156, 16);
			panel.add(lblConsultaFuncionario);
			...
			lblCargo.setBounds(213, 136, 45, 16);
			panel.add(lblCargo);
			
			JLabel lblMatricula = new JLabel("Matricula:");
			lblMatricula.setForeground(Color.BLACK);
			lblMatricula.setFont(new Font("SansSerif", Font.BOLD, 12));
			lblMatricula.setBounds(463, 139, 61, 16);
			panel.add(lblMatricula);
			
			JLabel lblCdMatricula = new JLabel("");
			lblCdMatricula.setHorizontalAlignment(SwingConstants.CENTER);
			lblCdMatricula.setForeground(Color.BLACK);
			lblCdMatricula.setFont(new Font("SansSerif", Font.BOLD, 12));
			lblCdMatricula.setBounds(454, 161, 78, 16);
			panel.add(lblCdMatricula);
			
			JCheckBox chckbxIsAtivo = new JCheckBox("Ativo");
			chckbxIsAtivo.setBounds(470, 216, 54, 18);
			panel.add(chckbxIsAtivo);
			
			JComboBox comboBoxCargos = new JComboBox();
			comboBoxCargos.setBounds(213, 153, 168, 26);
			...
			lblEspecialidade.setBounds(32, 190, 90, 16);
			panel.add(lblEspecialidade);
			
			JComboBox comboBoxEspecialidade = new JComboBox();
			comboBoxEspecialidade.setBounds(32, 208, 168, 26);
