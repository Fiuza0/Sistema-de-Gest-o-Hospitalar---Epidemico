...
public class ListaEspecialidadesView extends JFrame{

	private JPanel contentPane;

	
	public ListaEspecialidadesView() {
		...
		final JList<Atendimento> listEspecialidades = new JList<Atendimento>();
		listEspecialidades.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		listEspecialidades.setModel(new AbstractListModel<Atendimento>() {
		...
		listEspecialidades.setSelectedIndex(0);
		listEspecialidades.setBounds(24, 16, 374, 202);
		scrollList.setViewportView(listEspecialidades);
		...
		lblEspecialidades.setForeground(new Color(47, 79, 79));
		lblEspecialidades.setFont(new Font("Lucida Sans", Font.BOLD, 14));
		lblEspecialidades.setBounds(245, 19, 105, 16);
