...
public class CadastroEspecialidadeView extends JFrame {
	...
	public CadastroEspecialidadeView() {
		...
		JLabel lblCadastroEspecialidade = new JLabel("Cadastro Especialidade");
