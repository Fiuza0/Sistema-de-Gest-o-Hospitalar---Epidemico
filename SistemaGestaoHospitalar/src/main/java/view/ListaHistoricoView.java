...
public class ListaHistoricoView extends JFrame{

	private JPanel contentPane;

	
	public ListaHistoricoView() {
		...
		final JList<Atendimento> listFuncionarios = new JList<Atendimento>();
		listFuncionarios.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		listFuncionarios.setModel(new AbstractListModel<Atendimento>() {
		...
		listFuncionarios.setSelectedIndex(0);
		listFuncionarios.setBounds(24, 16, 374, 202);
		scrollList.setViewportView(listFuncionarios);
		...
		lblFuncionarios.setForeground(new Color(47, 79, 79));
		lblFuncionarios.setFont(new Font("Lucida Sans", Font.BOLD, 14));
		lblFuncionarios.setBounds(251, 19, 92, 16);
