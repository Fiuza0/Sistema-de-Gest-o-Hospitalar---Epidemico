...
public class ConsultaHistoricoView extends JFrame {
	...
	public ConsultaHistoricoView() {
		...
		JLabel lblConsultaHistorico = new JLabel("Consulta Historico");
		lblConsultaHistorico.setForeground(new Color(47, 79, 79));
		lblConsultaHistorico.setFont(new Font("Lucida Sans", Font.BOLD, 14));
		lblConsultaHistorico.setBounds(230, 27, 135, 16);
		panel.add(lblConsultaHistorico);
		
		JComboBox comboBoxFuncionarios = new JComboBox();
		comboBoxFuncionarios.setBounds(207, 109, 180, 28);
		panel.add(comboBoxFuncionarios);
		
		JLabel lblFuncionario = new JLabel("Funcionario:");
		lblFuncionario.setBounds(260, 90, 74, 16);
