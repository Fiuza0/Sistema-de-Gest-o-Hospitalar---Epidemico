...
public class ConsultaCargoView extends JFrame {
	...
	public ConsultaCargoView() {
		...
		lblSucesso.setBounds(225, 287, 144, 16);
		...
		lblNomeDoCargo.setBounds(249, 70, 97, 16);
		...
		JLabel lblCadastroEspecialidade = new JLabel("Consulta Cargo");
		...
		lblCadastroEspecialidade.setBounds(237, 27, 121, 16);
		...
		JLabel lblCdCargo = new JLabel("");
		lblCdCargo.setHorizontalAlignment(SwingConstants.CENTER);
		lblCdCargo.setForeground(Color.BLACK);
		lblCdCargo.setFont(new Font("SansSerif", Font.BOLD, 12));
		lblCdCargo.setBounds(230, 181, 135, 16);
		panel.add(lblCdCargo);
